...
public class RsaPkTest {
    ...
    public void testRSAMap() {
        ...
        String rsaPrivateKeyString = "{\n" +
                ...
                "}";
        Map<String, Object> mapPrivateKey = GsonFactory.newInstance().createGson().fromJson(rsaPrivateKeyString, new TypeToken<Map<String, Object>>() {
        }.getType());
        ...
        Assert.assertEquals(2, mapPrivateKey.size());
        ...
        String rsaPublicKeyString = "{\n" +
                ...
                "}";
        Map<String, Object> mapPublicKey = GsonFactory.newInstance().createGson().fromJson(rsaPublicKeyString, new TypeToken<Map<String, Object>>() {
        }.getType());
        ...
        Assert.assertEquals(2, mapPublicKey.size());
    }
}
